...
//Drop Down Menu
        ...
        // Group links toggle
        var group = false;
        $('.drop-down-show .trigger').click(function () {
            if (group == false) {
        ...
        //If someone clicks anywhere other than on the group slide, and the group slide is open, then close it.
        $('.drop-down-show .dropmenu-container ul').click(function(e) { 
          e.stopPropagation();
         })
        $(document).click(function() {
            if(group == true) {
                $('.drop-down-show .trigger').removeClass('clicked');
                $('.drop-down-show .trigger').next().slideUp();
                group = false;
            }
        });		
